...
apt-get update
apt-get install -y python3 python3-venv python3-pip usb-modeswitch modemmanager network-manager wireguard-tools sqlite3 openssh-client
...
systemctl restart powergateway-ha-tunnel.service || true
