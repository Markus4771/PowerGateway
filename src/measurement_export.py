...
bleiben Aufgabe von Home Assistant.
"""
...
def measurement_keys() -> Response:
    ...
    return jsonify({"items": sorted(keys.values(), key=lambda item: item["name"]), "snapshots": len(_records(168))})
